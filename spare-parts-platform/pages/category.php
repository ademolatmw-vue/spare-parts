...
if ($conn) {
    ...
    if ($cat_result->num_rows > 0) {
        ...
        $stmt_prod = $conn->prepare("SELECT p.product_name, p.price, p.brand, c.category_name, p.stock_quantity, p.model_compatibility, p.image_url, p.image_url, p.description FROM products p JOIN categories c ON p.category_id = c.category_id WHERE p.category_id = ? LIMIT 12");
        ...
        <div class="container">
            ...
            <div class="products-grid">
                ...
                <div class="product-card">
                    <?php
                        $imgPath = $p['image_url'] ?? ($p['image_url'] ?? '');
